...
<div align="center">
  <h1><b>Hello React FrontEnd</b></h1><a name="about-project"></a>
</div>
...
- **Set up store and greetings slice**
...
```sh
  cd my-folder
  git clone https://github.com/Luiscarlosvd/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/Luiscarlosvd/hello-react-front-end/issues).
